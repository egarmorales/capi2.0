...
class CreateContratoAutorizadoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contrato_autorizadores', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('contrato_autorizadores');
    }
}
